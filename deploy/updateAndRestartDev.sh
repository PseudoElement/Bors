...
echo "CLONING FROM git@git.softndit.com:moon-tycoon/frontend.git TO /home/ubuntu/frontend"

# clone the repo again
git clone git@git.softndit.com:moon-tycoon/frontend.git /home/ubuntu/frontend
